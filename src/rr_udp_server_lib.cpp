...
void RrUdpServerLib::init() {
  auto topic_callback =
      std::bind(&RrUdpServerLib::subscriber, this, std::placeholders::_1);
  subscription_ = this->create_subscription<RR_UDP_SVR_MSG_CLASS>(
      RR_UDP_SVR_READ_TOPIC, 10, topic_callback);
}
